function example3_Rank_vrs_MSE()

    % Example 3: Rank vrs MSE
    ...
    figure
    hold on
    plot(vectRank/m1,vectTv0,'-rx','LineWidth',2,'MarkerSize',8) 
    plot(vectRank/m1,vectGBT2,'-g+','LineWidth',2,'MarkerSize',8)
    plot(vectRank/m1,vectTv1,'-b.','LineWidth',2,'MarkerSize',15)           
    xlabel('Reduction ratio', 'FontSize',14)
